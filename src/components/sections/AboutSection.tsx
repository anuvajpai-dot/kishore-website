      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="font-serif text-4xl md:text-5xl text-[#f5f0eb] font-light mb-6 leading-tight">
              From{" "}
            ...
            <motion.p variants={fadeUp} className="text-[#909090] leading-relaxed mb-6 text-lg font-light">
            ...
            <motion.p variants={fadeUp} className="text-[#707070] leading-relaxed mb-8">
            ...
            <motion.p variants={fadeUp} className="text-[#707070] leading-relaxed mb-10">
